...
public class PetController {
	...
	public static Logger logger = LoggerFactory.getLogger(PetController.class);
	...
	public ResponseEntity<Void> createRequest(@RequestBody String str){
		
		logger.info("Tryying to create a request");
		logger.info(str);
